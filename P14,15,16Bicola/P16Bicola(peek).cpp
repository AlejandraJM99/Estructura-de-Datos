...
class Bicola
{
	...
	/*El método de peekAll muestra todos los elementos de la bicola mediante un ciclo for.*/
	void peekAll()
	{
    if(front == rear)
    {
	...
	//El método de peekFirst muestra la cabeza de la bicola.
	void peekFirst()
	{
	if(front == rear)
    {
	...
	//El método peekLaste muestra el final de la bicola.
	void peekLast()
	{
	if(front == rear)
    {
	...
	//El método peekIndex permite al usuario seleccionar una posición para buscar un dato.
...
int main() //En la función principal main(), se crean las variables a utilizar y la variable de tipo Bicola para poder llamar a los métodos de la clase.
{
	...
	do
	{
		...
		case 1: //Si escoge la opción 1 de entrada restringida, solamente podrá insertar elementos por el final de la cola pero podrá eliminar tanto por frente como por detrás.
		system("CLS");	
		...
		switch(op2)
		{
			...
			break;
			case 3: //El caso 3 despliega un nuevo submenú donde puede escoger que elemento mostrar.
			system("CLS");	
		...
		case 2: //Si escoge la opción 2 de salida restringida, podrá insertar elementos por el final y por el frente de la cola pero solo eliminar por el final.
		system("CLS");
		cout<<"1.Insertar final \n2.Insertar frente \n3.Eliminar \n4.Mostrar \n5.Volver al menu principal \nTu opcion es:  ";
		cin>>op2;
		switch(op2)
		{
			...
			dato = BC.eliminarRear();
			break;	
			case 4: //el caso 4 despliega un nuevo submenú donde puede escoger que elemento mostrar.
			system("CLS");	
			cout<<"1.Frente de la cola \n\n2.Final de la cola \n\n3.Todos los elementos de la cola \n\n4.Posicion especifica \n\n5.Volver al menu principal \n\nTu opcion es: ";
			cin>>op2;
			switch(op2)
